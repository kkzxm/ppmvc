...
public class WordAndTypeController extends ABaseController<WordAndType> {
    public WordAndTypeController(ABaseDoIt<WordAndType> aBaService) {
        super(aBaService, "单词与类型关系");
    }
}
